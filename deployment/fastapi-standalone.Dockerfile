...
# Copier les requirements FastAPI (sans Django)
...
# Copier uniquement les fichiers nécessaires pour FastAPI (sans Django)
COPY E3_model_IA/scripts/ /app/E3_model_IA/scripts/
COPY E3_model_IA/backend/fastapi_app/ /app/E3_model_IA/backend/fastapi_app/
COPY E1_gestion_donnees/ /app/E1_gestion_donnees/
COPY src/ /app/src/
COPY knowledge_base/ /app/knowledge_base/
COPY data/ /app/data/

# Définir le PYTHONPATH (sans Django)
