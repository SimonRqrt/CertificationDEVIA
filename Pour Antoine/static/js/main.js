...
function goBack() {
    // Si c'est possible, retourner à la page précédente
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Gestion de l'affichage du bouton de retour
    const backBtn = document.getElementById('backBtn');
    const isHomePage = window.location.pathname === '/' || window.location.pathname === '/api/v1/core/';
    ...
    // Vérification du statut des services - DÉSACTIVÉE
    ...
    // // Ajouter des classes CSS pour les statuts - DÉSACTIVÉ
