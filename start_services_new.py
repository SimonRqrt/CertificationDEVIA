#!/usr/bin/env python3
"""
Script pour démarrer les services avec la nouvelle architecture
"""
...
DJANGO_APP_DIR = BASE_DIR / 'E3_model_IA' / 'backend' / 'django_app'
FASTAPI_APP_DIR = BASE_DIR / 'E3_model_IA' / 'backend' / 'fastapi_app'
STREAMLIT_APP_DIR = BASE_DIR / 'E4_app_IA' / 'frontend' / 'streamlit_app'
...
def main():
    """Fonction principale"""
    print("🎯 Démarrage des services Coach AI (nouvelle architecture)...")
